...
class BackgroundVideo{
    ...
    func setUpBackground(){
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(BackgroundVideo.loopVideo), name:UIApplicationWillEnterForegroundNotification , object: nil)
        hasBeenUsed = true
